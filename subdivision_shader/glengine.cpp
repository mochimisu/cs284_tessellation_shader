...
void GLEngine::setupScene(void)
{
	...
	Shader * pn_tri = new Shader("PN Triangle Tessellation");
	pn_tri->initShader(GL_VERTEX_SHADER, "shaders/vert.glsl");
	pn_tri->initShader(GL_TESS_CONTROL_SHADER, "shaders/pn_triangles/pn.tess.control.glsl");
	pn_tri->initShader(GL_TESS_EVALUATION_SHADER, "shaders/pn_triangles/pn.tess.eval.glsl");
	pn_tri->initShader(GL_GEOMETRY_SHADER, "shaders/geometry.glsl");
	pn_tri->initShader(GL_FRAGMENT_SHADER, "shaders/frag.glsl");
	pn_tri->initProgram();

	Shader * phong_tes = new Shader("Phong Tessellation");
	phong_tes->initShader(GL_VERTEX_SHADER, "shaders/vert.glsl");
	phong_tes->initShader(GL_TESS_CONTROL_SHADER, "shaders/phong_tessellation/pt.tess.control.glsl");
	phong_tes->initShader(GL_TESS_EVALUATION_SHADER, "shaders/phong_tessellation/pt.tess.eval.glsl");
	phong_tes->initShader(GL_GEOMETRY_SHADER, "shaders/geometry.glsl");
	phong_tes->initShader(GL_FRAGMENT_SHADER, "shaders/frag.glsl");
	phong_tes->initProgram();
	Shader * adapt_phong_tes = new Shader("Adaptive Phong Tessellation");
	adapt_phong_tes->initShader(GL_VERTEX_SHADER, "shaders/vert.glsl");
	adapt_phong_tes->initShader(GL_TESS_CONTROL_SHADER, "shaders/phong_tessellation/pt.adaptive.tess.control.glsl");
	adapt_phong_tes->initShader(GL_TESS_EVALUATION_SHADER, "shaders/phong_tessellation/pt.tess.eval.glsl");
	adapt_phong_tes->initShader(GL_GEOMETRY_SHADER, "shaders/geometry.glsl");
	adapt_phong_tes->initShader(GL_FRAGMENT_SHADER, "shaders/frag.glsl");
	adapt_phong_tes->initProgram();
	Shader * adapt_phong_tes_vis = new Shader("Adaptive Phong Tessellation Visualization");
	adapt_phong_tes_vis->initShader(GL_VERTEX_SHADER, "shaders/vert.glsl");
	adapt_phong_tes_vis->initShader(GL_TESS_CONTROL_SHADER, "shaders/phong_tessellation/pt.adaptive.tess.control.glsl");
	adapt_phong_tes_vis->initShader(GL_TESS_EVALUATION_SHADER, "shaders/phong_tessellation/pt.tess.eval.glsl");
	adapt_phong_tes_vis->initShader(GL_GEOMETRY_SHADER, "shaders/adaptive_phong_visualization/adaptive_vis.geometry.glsl");
	adapt_phong_tes_vis->initShader(GL_FRAGMENT_SHADER, "shaders/adaptive_phong_visualization/adaptive_vis.frag.glsl");
	adapt_phong_tes_vis->initProgram();


	shaders.push_back(avg_tes);
	shaders.push_back(pn_tri);
	shaders.push_back(phong_tes);
	shaders.push_back(adapt_phong_tes);
